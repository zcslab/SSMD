...
"rm.likelihood.plot" <-
function(thresholds, log.le, log.lw, smooth.par = 0.5, fn = NULL, interactive = interactive)
{
	t = thresholds
...
"rm.distance.plot" <-
function(thresholds, dist.Expon, dist.Wigner, smooth.par = 0.5, fn = NULL, interactive = interactive)
{	
	t = thresholds
	le = dist.Expon
	lw = dist.Wigner
...
"rm.show.test" <- 
function(thresholds, p.values, main = "P-value vs. threshold", fn = "pval.vs.threshold.png", interactive = interactive)
{
...
"rm.sse.plot" <- 
function(thresholds, sse.values, main = "SSE for NNSD <--> Exponential", fn = "RMT.SSE.vs.Thres.png", interactive = interactive)
{
